...
You cna go to  `HERE <https://code.visualstudio.com/>'_ to download the right version and `HERE 
<https://code.visualstudio.com/docs/setup/setup-overview>`_ for **set up** and **get started** as you follow the instructions
